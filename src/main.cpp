...
int main(int argc, char *argv[])
{
	...
	keyStrokes.connect(&keyMonitor, SIGNAL(keyPressed(unsigned)), SLOT(downKey(unsigned)));
	keyStrokes.connect(&keyMonitor, SIGNAL(keyReleased(unsigned)), SLOT(upKey(unsigned)));
